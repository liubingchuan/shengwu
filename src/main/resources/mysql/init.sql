...
CREATE TABLE IF NOT EXISTS yiyao_relation (
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS yiyao_linkuser (
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS yiyao_order (
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
  uuid varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS yiyao_price(
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS yiyao_patent(
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
